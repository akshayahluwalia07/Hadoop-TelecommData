...
public class telecommdata {
	...
	public static void main(String[] args) throws Exception
	{
		...
		Job job= new Job(conf, "Telecomm Data");
		job.setJarByClass(telecommdata.class);
	...
	job.setMapperClass(telecommmapper.class);
	job.setReducerClass(telecommreducer.class);
